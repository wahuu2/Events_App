          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-7 text-center sm:mb-8">
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm leading-6 text-foreground-secondary">
                Join Eventora to discover events, make bookings, and keep your
            ...
            <p className="mt-6 text-center text-[11px] leading-5 text-foreground-muted">
              Create an account to manage bookings, payments, digital tickets,
              notifications, and your event activity.
            </p>
          </div>
        </div>
